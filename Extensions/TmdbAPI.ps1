    ...
    End{
        If($entrys){
            ...
            Foreach($entry in $entrys) {
                ...
                $returnObject | Add-Member -Type NoteProperty -Name SearchTitle -Value $Title
                ...
                $returnObject | Add-Member -Type NoteProperty -Name Year -Value (Get-Date $entry.release_date).Year
